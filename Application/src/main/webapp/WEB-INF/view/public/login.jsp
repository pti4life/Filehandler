...
<body>
    ...
    <form class="flex-row justify-content-center align-items-center align-content-center align-self-center" method="post">
        ...
        <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Bejelentkezés</button></div><a href="#" class="forgot" style="align-content:center;">Elfelejtett jelszó vagy felhasználó név?</a></form>
